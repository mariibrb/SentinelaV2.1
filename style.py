...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* 2. MENU SUPERIOR - CORES DAS ZONAS */
        div.stButton > button { color: white !important; border: none !important; border-radius: 15px !important; font-family: 'Montserrat', sans-serif !important; font-weight: 800 !important; height: 75px !important; text-transform: uppercase; opacity: 0.7; }
        ...
        /* 3. NEUTRALIZAÇÃO DO UPLOADER (MATANDO O AZUL DO ZIP XML) */
        /* Força a borda, o texto e os ícones para tons de cinza neutro */
        ...
        /* Tira o azul do texto "Drag and drop files here" e "Limit 200MB" */
        [data-testid="stFileUploader"] section > div > div > span,
        [data-testid="stFileUploader"] section > div > div > small {
            color: #6C757D !important;
        }

        /* Tira o azul do ícone de nuvem/upload */
        [data-testid="stFileUploader"] svg {
            fill: #6C757D !important;
        }

        /* O BOTÃO BROWSE FILES RIGOROSAMENTE CINZA */
        ...
        .stTabs [data-baseweb="tab"] { border-radius: 10px 30px 0 0 !important; font-weight: 700; background: rgba(255,255,255,0.5) !important; }
        </style>
