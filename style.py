...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* --- 2. FORMA DAS ABAS (DESIGN DIAMANTE) --- */
        /* Isso aplica o formato bonito em TODAS as abas, mas sem cor ainda */
        ...
        /* O seletor "> div" garante que estamos falando só das abas principais */
        .stTabs > div > [data-baseweb="tab-list"] > button:nth-of-type(1)[aria-selected="true"] { background: #00BFFF !important; transform: translateY(-30px) !important; color: white !important; }
        .stTabs > div > [data-baseweb="tab-list"] > button:nth-of-type(2)[aria-selected="true"] { background: #FF69B4 !important; transform: translateY(-30px) !important; color: white !important; }
        .stTabs > div > [data-baseweb="tab-list"] > button:nth-of-type(3)[aria-selected="true"] { background: #2ECC71 !important; transform: translateY(-30px) !important; color: white !important; }


        /* --- 3. A LÓGICA DE CORES DOS FILHOS (A SOLUÇÃO DO PROBLEMA) --- */
        /* Usamos ":has" para checar quem é o pai ativo. As regras não se misturam. */

        /* === CENÁRIO 1: MÃE AZUL ESTÁ ATIVA? === */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(1)[aria-selected="true"]) {
            /* Pinta QUALQUER filha selecionada de Azul */
        ...
        /* === CENÁRIO 2: MÃE ROSA ESTÁ ATIVA? (AQUI O RET VIRA ROSA) === */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(2)[aria-selected="true"]) {
            /* Pinta QUALQUER filha selecionada de Rosa (Inclusive a 3ª) */
        ...
        /* === CENÁRIO 3: MÃE VERDE ESTÁ ATIVA? === */
        /* Esta regra SÓ funciona se a Mãe Verde estiver ativa. Se estiver na Rosa, o CSS ignora isso. */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(3)[aria-selected="true"]) {
            /* Pinta QUALQUER filha selecionada de Verde */
        ...
        /* --- 4. AJUSTES FINAIS DE ACABAMENTO --- */
        ...
        /* Reset para sub-abas não selecionadas (Ficam cinza) */
        [data-testid="stTabPanel"] .stTabs [data-baseweb="tab"] { 
            height: 60px !important; 
            background: #F1F3F5 !important; 
            border-radius: 15px 45px 0 0 !important; 
            transform: none !important; /* Remove elevação das filhas inativas */
        }
