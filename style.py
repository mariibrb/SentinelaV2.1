...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* --- 5. LÓGICA DE HERANÇA POR BLOCO (FILHAS IGUAIS ÀS MÃES) --- */
        ...
        .stTabs:has(button:nth-of-type(1)[aria-selected="true"]) .stTabs [aria-selected="true"] { background-color: #00BFFF !important; color: white !important; }
        ...
        .stTabs:has(button:nth-of-type(2)[aria-selected="true"]) .stTabs [aria-selected="true"] { background-color: #FF69B4 !important; color: white !important; }
        ...
        .stTabs:has(button:nth-of-type(3)[aria-selected="true"]) .stTabs [aria-selected="true"] { background-color: #2ECC71 !important; color: white !important; }
        ...
        /* --- 6. ÍCONE NO ENVELOPE --- */
        [data-testid="stFileUploader"] { position: relative !important; margin: 25px 0 !important; }
        [data-testid="stFileUploader"]::before {
            content: "📄"; position: absolute; top: -32px; left: 50%; transform: translateX(-50%); font-size: 30px; z-index: 9;
        }
