...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* --- 3. SELETORES MESTRES (BLINDAGEM TOTAL) --- */
        
        /* === BLOCO 1: AZUL (XML) === */
        /* Detecta se a Mãe 1 está ativa */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(1)[aria-selected="true"]) {
            /* Pinta a Mãe */
            > div > [data-baseweb="tab-list"] > button:nth-of-type(1) { background: #00BFFF !important; transform: translateY(-30px) !important; color: white !important; }
            /* Pinta TODAS as filhas */
        ...
        /* === BLOCO 3: VERDE (APURAÇÃO) === */
        /* COLOQUEI O VERDE ANTES DO ROSA NO CÓDIGO PARA ELE SER MAIS FRACO */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(3)[aria-selected="true"]) {
            > div > [data-baseweb="tab-list"] > button:nth-of-type(3) { background: #2ECC71 !important; transform: translateY(-30px) !important; color: white !important; }
        ...
        /* === BLOCO 2: ROSA (CONFORMIDADE) - O CHEFÃO === */
        /* Este bloco está por último para mandar em todos os conflitos */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(2)[aria-selected="true"]) {
            /* Pinta a Mãe */
            > div > [data-baseweb="tab-list"] > button:nth-of-type(2) { background: #FF69B4 !important; transform: translateY(-30px) !important; color: white !important; }
            
            /* Pinta TODAS as filhas de Rosa */
            [data-testid="stTabPanel"] button[aria-selected="true"] { background-color: #FF69B4 !important; color: white !important; }

            /* 🚨 VACINA ANTI-VERDE PARA O RET 🚨 */
            /* Aqui eu digo: "Ei, 3ª filha da casa Rosa, EU PROÍBO VOCÊ DE SER VERDE!" */
            [data-testid="stTabPanel"] button:nth-of-type(3)[aria-selected="true"] { 
