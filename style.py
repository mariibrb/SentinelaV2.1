...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* ✨ BRILHO METALIZADO NO HOVER (QUANDO PASSA O MOUSE) */
        ...
        /* Cores das Mães Ativas (Modelo Rihanna) */
        ...
        /* --- 4. AS FILHAS (SUB-ABAS) - HIERARQUIA GENÉTICA --- */
        /* Blindagem: Se a Mãe 2 (ROSA) está ativa, todas as sub-abas selecionadas dentro dela são ROSAS */
        ...
        /* Blindagem: Se a Mãe 3 (VERDE) está ativa, todas as sub-abas selecionadas dentro dela são VERDES */
        ...
        /* Estilo base das filhas não selecionadas */
