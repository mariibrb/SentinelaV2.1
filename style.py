...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        .stApp { background: radial-gradient(circle at top right, #F8F9FA 0%, #DEE2E6 100%) !important; }
        ...
        /* 2. MENU MASTER (BOTÕES SUPERIORES) - ESTILO PASTINHA RESTAURADO */
        div.stButton > button {
        ...
        /* IDENTIDADE POR ZONA NO MENU SUPERIOR */
        ...
        /* 3. ABAS INTERNAS (TABS) - AS CORES VOLTARAM */
        ...
        div:has(#modulo-amarelo) .stTabs [aria-selected="true"] { background-color: #FFD700 !important; color: #212529 !important; }
        ...
        /* --- BLINDAGEM DO BOTÃO BROWSE (ÚNICA PARTE CINZA) --- */
