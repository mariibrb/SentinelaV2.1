...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        .stTabs [data-baseweb="tab-list"] { gap: 15px !important; padding: 60px 0 0 20px !important; background: transparent !important; }
        ...
        /* ATIVAÇÃO DAS MÃES (ESTADOS DO WAR) */
        ...
        /* --- 3. ⚔️ LEI DO TERRITÓRIO (SUB-ABAS) ⚔️ --- */
        /* Estilo base das filhas */
        ...
        /* 🟦 TERRITÓRIO 1: Se a mãe no topo é AZUL, todas as sub-abas selecionadas são AZUIS */
        ...
        /* 🟥 TERRITÓRIO 2: Se a mãe no topo é ROSA, todas as sub-abas selecionadas são ROSAS */
        ...
        /* 🟩 TERRITÓRIO 3: Se a mãe no topo é VERDE, todas as sub-abas selecionadas são VERDES */
        ...
        /* Envelopes seguindo o território */
        ...
        div.stDownloadButton > button {
            background: linear-gradient(180deg, #FFFFFF 0%, #DEE2E6 100%) !important;
            color: #495057 !important; border: 2px solid #ADB5BD !important; border-radius: 15px !important; font-weight: 800 !important; height: 55px !important; width: 100% !important; text-transform: uppercase !important;
        }
