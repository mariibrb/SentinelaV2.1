...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* =================================================================================
           2. DESIGN DAS ABAS (FORMATO FÍSICO)
        ================================================================================= */
        ...
        /* Mães Ativas (Design Genérico - as cores virão nos blocos abaixo) */
        .stTabs > div > [data-baseweb="tab-list"] > button[aria-selected="true"] {
            transform: translateY(-30px) !important; color: white !important;
        }

        /* =================================================================================
           3. OS BUNKERS (ISOLAMENTO TOTAL POR NÚMERO DO BOTÃO)
        ================================================================================= */

        /* ---------------------------------------------------------------------------------
           BUNKER 1: ANÁLISE XML (AZUL)
           Regra: Se o botão Nº 1 do topo estiver ativo, TUDO vira AZUL.
        --------------------------------------------------------------------------------- */
        ...
        /* ---------------------------------------------------------------------------------
           BUNKER 2: CONFORMIDADE (ROSA)
           Regra: Se o botão Nº 2 do topo estiver ativo, TUDO vira ROSA.
        --------------------------------------------------------------------------------- */
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-of-type(2)[aria-selected="true"]) {
            ...
            /* Pinta QUALQUER filha selecionada de Rosa (Aqui salvamos o RET) */
            [data-testid="stTabPanel"] button[aria-selected="true"] { background-color: #FF69B4 !important; color: white !important; }
            
            /* FORÇA EXTRA: Garante que o 3º filho (RET) seja Rosa e não Verde */
            [data-testid="stTabPanel"] button:nth-of-type(3)[aria-selected="true"] { background-color: #FF69B4 !important; }

            /* Neon e Envelopes Rosas */
        ...
        /* ---------------------------------------------------------------------------------
           BUNKER 3: APURAÇÃO (VERDE)
           Regra: Se o botão Nº 3 do topo estiver ativo, TUDO vira VERDE.
        --------------------------------------------------------------------------------- */
