...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* =================================================================================
           2. DESIGN DAS ABAS (FORMATO DIAMANTE)
        ================================================================================= */
        ...
        /* =================================================================================
           3. LÓGICA DE CORES DAS SUB-ABAS (ORDEM É CRUCIAL)
        ================================================================================= */
        
        /* Reset Geral das Sub-abas */
        ...
        /* --- PRIMEIRO DEFINIMOS O VERDE (PARA ELE SER FRACO) --- */
        /* Território 3: APURAÇÃO */
        ...
        /* --- POR ÚLTIMO DEFINIMOS O ROSA (PARA ELE GANHAR DE TODOS) --- */
        /* Território 2: CONFORMIDADE */
        ...
        /* 🚨 VACINA DO RET: FORÇA BRUTA NO 3º FILHO DA CASA ROSA 🚨 */
        /* Isso aqui garante que se estiver na Casa 2, o botão 3 (RET) TEM que ser rosa, ignorando qualquer regra verde anterior */
