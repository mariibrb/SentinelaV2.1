...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* =================================================================================
           2. DEFINIÇÃO GLOBAL DOS OBJETOS (PARA NADA SUMIR)
        ================================================================================= */
        ...
        /* Forma do Envelope (AGORA É GLOBAL - NÃO VAI SUMIR) */
        [data-testid="stFileUploader"] {
            ...
            background-color: #F8F9FA; /* Cor base caso a lógica falhe */
        }
        ...
        /* =================================================================================
           3. LÓGICA DE CORES (AQUELA QUE FUNCIONA)
        ================================================================================= */

        /* --- MÃES (NÍVEL 1) --- */
        /* Usamos > div > ... para garantir que só pega as abas do topo */
        ...
        /* --- FILHAS (SUB-ABAS) E ENVELOPES --- */
        /* Aqui usamos o :has() para verificar quem é o Pai */
        ...
        .stTabs:has(> div > [data-baseweb="tab-list"] > button:nth-child(2)[aria-selected="true"]) {
            ...
            /* Filhas (AQUI O RET VAI SER ROSA, PORQUE A REGRA VERDE NÃO EXISTE AQUI) */
