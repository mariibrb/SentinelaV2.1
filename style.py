...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* ✨ BRILHO METALIZADO DIAMANTE (HOVER) */
        ...
        /* Elevação e Cor das Mães Selecionadas */
        ...
        /* --- 4. SUB-ABAS (A LÓGICA DE ONTEM RESTAURADA) --- */
