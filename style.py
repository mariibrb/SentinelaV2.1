...
def aplicar_estilo_sentinela():
    st.markdown("""
        ...
        /* 5. A REGRA SAGRADA: BOTÃO BROWSE SEMPRE CINZA EM QUALQUER ZONA */
        /* Aqui eu forço a neutralidade independente de onde você esteja */
